...
<div class="container">
    <div class="row">
        <div class="col-lg-6 mx-auto">
            <form method="POST" class="bg-light border p-5" action="index.php?controller=TransactionController&action=update&id=<?php echo $selectedTransaction->id ;?>">
                ...
                <div class="form-group">
                    <label for="subcategory" class="form-label mt-2">Subcategory</label>
                ...
                <div class="form-group">
                    <label for="currencyCode" class="form-label mt-2">Currency code</label>
                ...
                <div class="form-group">
                    <label for="selectedTransaction[date]" class="form-label mt-2">Date</label>
                    <?php
                        $createDate = new DateTime($selectedTransaction->Date);
                        $strip = $createDate->format('Y-m-d');
                    ?>
                    <input type="date" name="selectedTransaction[date]" class="form-control" value="<?php echo $strip; ?>">
                </div>
                <div class="form-group">
                    <label for="selectedTransaction[comment]" class="form-label mt-2">Comment</label>
